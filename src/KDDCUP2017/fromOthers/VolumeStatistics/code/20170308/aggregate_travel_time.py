...
def avgTravelTime(in_file):
    ...
    out_suffix = '_20min_avg_travel_time_8-10'
    ...
    for i in range(len(traj_data)):
        ...
        # if trace_start_time.hour >= 8 and trace_start_time.hour <= 9:
        if start_time_window not in travel_times[route_id]:
            travel_times[route_id][start_time_window] = list()
        travel_times[route_id][start_time_window].append(tt)
        # print travel_times[route_id][start_time_window]
